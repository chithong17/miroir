          ...
          <>
            <section className="grid gap-6 lg:grid-cols-[minmax(0,0.95fr)_minmax(420px,1.05fr)]">
              ...
              <div className="glass-panel p-5 sm:p-7 lg:p-9">
                ...
                <h1 className="mt-3 font-display text-3xl font-black leading-tight text-ink sm:text-5xl">
                  {product.name}
                </h1>
                <p className="mt-4 text-3xl font-black text-mintDeep">
                  {formatMoney(product.price)}
                </p>
                <p className="mt-6 text-base leading-7 text-muted">
                  {product.description ||
                    "Shop chưa cung cấp mô tả cho sản phẩm này."}
                </p>
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-2">
                  <a
                    className="soft-button block text-center"
                    href={`/app/try-on?productId=${encodeURIComponent(product.id)}`}
                  >
                    Thử đồ với AI
                  </a>
                  {product.shopId ? (
                ...
                {product.shop ? (
                  <div className="mt-6 rounded-2xl border border-line bg-white p-4">
                    ...
                    <p className="mt-1 text-sm text-muted">
                      {product.shop.contact?.address ||
                        product.shop.contact?.email ||
                        "Shop chưa cập nhật thông tin liên hệ."}
                    </p>
                  </div>
                ) : null}
              </div>

...
export default function TryOnStudioPage() {
  ...
  useEffect(() => {
    if (currentTask) {
      ...
      if (currentTask.status === "completed") {
        ...
        setMessage(
          "MIROIR is creating your virtual try-on in the background...",
        );
        setPreviewState("original");
      }
    }
  ...
  const loadProduct = async (productId) => {
    ...
    try {
      ...
      setRelatedProducts(
        (related.products || []).filter((item) => item.id !== productId),
      );
  ...
  const startTryOn = async () => {
    ...
    if (isPlatform && !product)
      return setMessage("Vui lòng chọn một sản phẩm từ marketplace.");
    if (!isPlatform && !hasCustomUploads)
      return setMessage("Vui lòng tải lên ảnh trang phục.");
    if (isPlatform && !isLoggedIn)
      return setMessage("Vui lòng đăng nhập để thử sản phẩm marketplace.");
    if (!isPlatform && !isLoggedIn && !modelFile)
      return setMessage("Vui lòng tải ảnh của bạn lên trước.");
  ...
  const glassPanelClass =
    "bg-white/45 backdrop-blur-[24px] border border-white/70 rounded-[28px] p-5 shadow-[0_20px_60px_rgba(80,110,70,0.06),inset_0_1px_0_rgba(255,255,255,0.9)] flex flex-col relative overflow-hidden group";
          ...
          <div className="flex flex-col lg:flex-row gap-5 lg:gap-6 xl:gap-8 items-stretch justify-center flex-1 min-h-0 lg:mt-[100px]">
            ...
            <aside className="w-full lg:w-[260px] xl:w-[280px] shrink-0 order-2 lg:order-1 flex flex-col gap-4 relative">
              ...
              <div className="text-left mb-2 sm:mb-4 shrink-0 px-2 lg:px-0 lg:absolute lg:bottom-full lg:left-0 lg:mb-8 lg:w-[380px]">
                <p className="text-[11px] font-black text-[#91B76F] uppercase tracking-[0.25em] mb-2">
                  Studio AI
                </p>
                ...
                <p className="text-[13px] text-gray-500 font-medium">
                  Tải ảnh, chọn sản phẩm và khám phá phong cách phù hợp nhất với
                  bạn.
                </p>
              </div>
              <div className={glassPanelClass}>
                ...
                <div className="relative z-10">
                  <h2 className="text-[15px] font-extrabold text-[#101512] mb-4">
                    Tải ảnh của bạn
                  </h2>
                  ...
                  >
                    {modelPreview ? (
                      ...
                      <div className="text-center p-4">
                        <svg
                          className="w-7 h-7 mx-auto text-[#91B76F] mb-3 transition-transform group-hover:-translate-y-1"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
                        ...
                        <span className="text-[12px] font-bold text-gray-400 block leading-relaxed">
                          Kéo thả ảnh vào đây
                          <br />
                          hoặc nhấn để tải ảnh
                        </span>
                      </div>
                    )}
                    <input
              ...
              <div className={glassPanelClass + " !p-4"}>
                ...
                <div className="relative z-10 flex gap-3">
                  ...
                  <div>
                    <h3 className="text-[13px] font-extrabold text-[#101512] mb-1.5">
                      Mẹo chụp ảnh
                    </h3>
              ...
              <div className="relative w-full max-w-[500px] aspect-[3/4] sm:aspect-[4/5] max-h-[calc(100vh-280px)] bg-white rounded-[32px] sm:rounded-[40px] shadow-[0_24px_80px_rgba(40,60,30,0.06)] border-[4px] sm:border-[6px] border-white/80 overflow-hidden flex flex-col group isolation-isolate mx-auto">
                ...
                <div className="w-full h-full relative bg-[#F8FAF7]">
                  ...
                  {modelPreview ? (
                    ...
                    <div
                      className={`absolute inset-0 w-full h-full flex flex-col items-center justify-center transition-opacity duration-700 ease-in-out bg-white ${previewState === "original" ? "opacity-100 z-10" : "opacity-0 z-0"}`}
                    >
                      <div className="text-center text-gray-300">
                        <svg
                          className="w-16 h-16 mx-auto opacity-40 mb-3"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
                    ...
                    <div className="absolute inset-0 z-20 bg-white/70 backdrop-blur-md flex flex-col items-center justify-center">
                      <div className="relative mb-6 flex h-20 w-20 items-center justify-center">
                        ...
                        <div className="relative grid grid-cols-2 gap-1.5">
                          ...
                          <span
                            className="h-1.5 w-1.5 rounded-full bg-[#91B76F] animate-pulse"
                          ...
                          />
                          <span
                            className="h-1.5 w-1.5 rounded-full bg-[#101512] animate-pulse"
                            style={{ animationDelay: "450ms" }}
                          />
                        </div>
                      </div>
                      <p className="text-[14px] font-extrabold text-[#101512]">
                        Đang tạo kết quả AI...
                      </p>
                  ...
                  {status === "error" && (
                    <div className="absolute inset-0 z-20 bg-white/80 backdrop-blur-md flex flex-col items-center justify-center p-6 text-center animate-in fade-in duration-300">
                      ...
                      <p className="text-[15px] font-extrabold text-[#101512] mb-2">
                        Không thể tạo ảnh
                      </p>
                      <p className="text-[13px] font-medium text-red-500 max-w-sm">
                        {message}
                      </p>
                      <button
                        onClick={() => setStatus("idle")}
                        className="mt-6 px-6 py-2 bg-white border border-gray-200 rounded-full text-xs font-bold text-gray-600 hover:text-[#101512] shadow-sm transition-colors"
                      >
                        Đóng
                      </button>
                    </div>
                ...
                <div
                  className={`absolute bottom-5 sm:bottom-6 right-5 sm:right-6 z-30 flex flex-col gap-2 sm:gap-3 transition-all duration-500 ${previewState === "result" ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4 pointer-events-none"}`}
                >
                  <button
                    className="w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-white/95 backdrop-blur-sm shadow-lg flex items-center justify-center text-gray-500 hover:text-[#101512] hover:scale-105 transition-all"
                    title="Mở rộng"
                  >
                    <svg
            ...
            <aside className="w-full lg:w-[280px] xl:w-[320px] shrink-0 order-3 lg:order-3 flex flex-col gap-4">
              <div
                className={
                  glassPanelClass +
                  " flex-1 flex flex-col lg:max-h-[calc(100vh-140px)]"
                }
              >
                <div className="absolute inset-[1px] rounded-[inherit] pointer-events-none bg-gradient-to-br from-white/60 to-transparent z-0" />

                <div className="relative z-10 flex flex-col h-full">
                  <h2 className="text-[15px] font-extrabold text-[#101512] mb-4 shrink-0">
                    ...
                    {garmentSource === "marketplace" ? (
                      <div>
                        ...
                        <div className="flex gap-2.5 overflow-x-auto pb-3 mb-2 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] shrink-0">
                          {["Tất cả", "Áo", "Quần", "Váy/Đầm", "Áo khoác"].map(
                            (cat, i) => (
                              <span
                                key={cat}
                                className={`text-[10px] font-extrabold uppercase tracking-wide px-3.5 py-1.5 rounded-full whitespace-nowrap border transition-colors cursor-pointer ${i === 0 ? "bg-[#91B76F] text-white border-[#91B76F] shadow-sm" : "bg-white/50 text-gray-500 border-white hover:bg-white/80"}`}
                              >
                                {cat}
                              </span>
                            ),
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-2 gap-3 mt-1">
                          ...
                          {relatedProducts.map((p) => (
                            <div
                              ...
                              className="aspect-[3/4] rounded-2xl border-[1.5px] border-white overflow-hidden cursor-pointer hover:border-[#91B76F]/60 hover:shadow-md transition-all bg-white/40 group"
                            >
                              <img
                                src={p.imageUrl}
                      ...
                      <div className="flex flex-col gap-5">
                        <SelectField
                          ...
                          onChange={(e) => setCustomTryOnType(e.target.value)}
                        >
                          <option value="dress">Váy / Đầm liền (1 mảnh)</option>
                          <option value="upper_lower">
                            Áo & Quần (2 mảnh)
                          </option>
                        </SelectField>
                            ...
                            >
                              {dressPreview ? (
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center">
                                  <svg
                                    className="w-6 h-6 text-[#91B76F] mb-2 transition-transform group-hover:-translate-y-1"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                  >
                              ...
                              <input
                                ...
                                accept="image/*"
                                onChange={(e) =>
                                  setGarmentFile("dress", e.target.files?.[0])
                                }
                              />
                            </div>
                          </div>
                            ...
                            <div>
                              ...
                              >
                                {upperPreview ? (
                                  ...
                                  <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center">
                                    <svg
                                      className="w-5 h-5 text-[#91B76F] mb-1 transition-transform group-hover:-translate-y-1"
                                      fill="none"
                                      viewBox="0 0 24 24"
                                      stroke="currentColor"
                                    >
                                ...
                                <input
                                  ...
                                  accept="image/*"
                                  onChange={(e) =>
                                    setGarmentFile("upper", e.target.files?.[0])
                                  }
                                />
                              </div>
                            </div>
                            <div>
                              ...
                              >
                                ...
                                <input
                                  ...
                                  accept="image/*"
                                  onChange={(e) =>
                                    setGarmentFile("lower", e.target.files?.[0])
                                  }
                                />
                              </div>
                            </div>
                  ...
                  <div className="pt-3 mt-1 shrink-0">
                    ...
                    {message && (
                      <p
                        className={`mt-3 text-[11.5px] text-center font-bold ${status === "error" ? "text-red-500" : "text-gray-500"}`}
                      >
                        {message}
                      </p>
                    )}
              ...
              {status === "completed" &&
                ...
                garmentSource === "marketplace" &&
                product &&
                completedTryOnProductId === product.id && (
                  <div
                    className={
                      glassPanelClass +
                      " !p-4 transition-all duration-500 animate-in fade-in slide-in-from-bottom-4"
                    }
                  >
                    ...
                    <div className="relative z-10 flex flex-col items-center text-center">
                      <p className="text-[13px] font-extrabold text-[#101512] mb-3">
                        Ưng ý với outfit này?
                      </p>

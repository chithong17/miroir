        ...
        <form onSubmit={handleSubmit} className="glass-panel p-5">
          ...
          <div className="grid gap-4">
            ...
            <button
              ...
              className="rounded-lg border border-line bg-white px-4 py-2 text-left text-sm font-semibold text-ink transition hover:border-tertiary"
            >
                  ...
                  <>
                    ...
                    <div className="space-y-6">
                      {outfits.map((outfit, index) => (
                        <article key={outfit.id || index} className="rounded-lg border border-line bg-white p-4">
                          ...
                          <div className="mt-4 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                            {(outfit.items || []).map((item) => (
                              <div key={item.product.id} className="rounded-lg border border-line bg-panelSoft p-3">
                          ...
                          <div className="mt-4 flex flex-wrap gap-3">
                            {feedbackTypes.map((eventType) => (
                              <button
                                ...
                                className="rounded-lg border border-line bg-white px-4 py-2 text-sm font-semibold text-ink transition hover:border-tertiary"
                              >
                                {eventType.replace("_", " ")}
                              </button>
                            ))}

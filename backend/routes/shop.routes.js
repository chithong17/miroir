...
import { requireActiveShopSubscription, requireGrowthShopSubscription } from "../middlewares/subscription.middleware.js";
...
router.get("/me/insights", requireGrowthShopSubscription, myShopInsights);
router.get("/me/advice", requireGrowthShopSubscription, myShopAdvice);
router.get("/me/strategy", requireGrowthShopSubscription, myShopStrategy);
